...
from acn.gnn.model import EDGE_DIM, IN_DIM, DirMultigraphSAGE, normalise_features
from acn.graph import chain_features, db, score
from acn.pseudonymise import buckets, hashing
...
def main():
    ...
    for inst in INSTITUTIONS:
        local_df = full_df[
            (full_df["src_institution"] == inst) | (full_df["dst_institution"] == inst)
        ]
        edges = []
        unique_nodes = set()
